				...
				<form id="joinform" action="joinService" method="post">
					...
					<table id="jointable">
						...
						<tr>
							...
							<td class="jointd2"><input type="password" id="input_pw"
								name="pw" required="required" placeholder="PW를 입력하세요"></td>
						</tr>
						<tr>
							<td class="jointd1">* 이름</td>
							<td class="jointd2"><input type="text" id="input_name"
								name="name" required="required" placeholder="이름을 입력하세요"></td>
						</tr>
						<tr>
							<td class="jointd1">* 전화번호</td>
							<td class="jointd2"><input type="tel" id="input_tel"
						...
						<tr>
							...
							<td class="jointd2">남 <input type="radio" name="gender"
								id="input_gender0" value="0"> 여 <input type="radio"
								name="gender" id="input_gender1" value="1">
							</td>
						</tr>
